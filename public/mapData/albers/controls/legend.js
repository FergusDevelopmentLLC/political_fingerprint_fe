class LegendMapControl {
    ...
    onAdd(map) {
      ...
      this.desc.innerHTML = "There are <span id='test-results-count'></span> total test results.<span id='county-more-detail'> Click on a county for more detail.</span><span id='county-3d-desc'> County height indicates number of tests for that county.</span>"
